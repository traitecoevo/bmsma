...
namespace model_ols_namespace {
using stan::model::model_base_crtp;
using namespace stan::math;
stan::math::profile_map profiles__;
static constexpr std::array<const char*, 10> locations_array__ =
  {" (found before start of program)",
  " (in 'ols', line 8, column 2 to column 17)",
  " (in 'ols', line 9, column 2 to column 12)",
  " (in 'ols', line 10, column 2 to column 22)",
  " (in 'ols', line 14, column 2 to column 42)",
  " (in 'ols', line 3, column 2 to column 17)",
  " (in 'ols', line 4, column 9 to column 10)",
  " (in 'ols', line 4, column 2 to column 14)",
  " (in 'ols', line 5, column 9 to column 10)",
  " (in 'ols', line 5, column 2 to column 14)"};
#include <stan_meta_header.hpp>
class model_ols final : public model_base_crtp<model_ols> {
private:
  int N;
...
public:
  ~model_ols() {}
  model_ols(stan::io::var_context& context__, unsigned int random_seed__ = 0,
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    // suppress unused var warning
    (void) DUMMY_VAR__;
    static constexpr const char* function__ = "model_ols_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_ols_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
...
using stan_model = model_ols_namespace::model_ols;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_ols_namespace::profiles__;
}
#endif
#endif
